...
const GoogleIcon = () => (
  <svg className="w-5 h-5" viewBox="0 0 48 48">
    ...
    <path fill="#34A853" d="M46.98 24.55c0-1.57-.15-3.09-.38-4.55H24v8.51h12.8c-.57 3.02-2.31 5.48-4.79 7.2l7.8 6.01C42.6 39.2 46.98 32.6 46.98 24.55z"></path>
    <path fill="#FBBC05" d="M10.53 28.59c-.48-1.45-.76-2.99-.76-4.59s.27-3.14.76-4.59l-7.98-6.19C.92 16.46 0 20.12 0 24c0 3.88.92 7.54 2.56 10.78l7.97-6.19z"></path>
    <path fill="#EA4335" d="M24 48c6.48 0 11.93-2.13 15.89-5.81l-7.8-6.01c-2.18 1.45-4.96 2.3-8.09 2.3-6.26 0-11.57-4.22-13.47-9.91l-7.98 6.19C6.51 42.62 14.62 48 24 48z"></path>
...
export const Step1Account: React.FC<StepProps> = ({ formData, updateFormData, nextStep, handleGoogleLogin, isSubmitting }) => {
  ...
  return (
    <div className="space-y-6 animate-fade-in-scale">
      ...
      <div className="flex items-center my-4">
        ...
        <span className="flex-shrink mx-4 text-xs text-texto-secundario uppercase">ou</span>
        <div className="flex-grow border-t border-borda"></div>
      </div>
