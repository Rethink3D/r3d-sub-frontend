...
const InviteForm: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-lg mx-auto border border-gray-300 dark:border-gray-600 bg-white dark:bg-[#181818] rounded-lg p-8 shadow-lg">
      <div className="flex flex-col items-center text-center mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400 mt-4 max-w-md">
          Buscamos Makers entusiastas e/ou prestadores de serviço em impressão
          3D para expandir nosso catálogo.
        </p>
        <p className="text-gray-600 dark:text-gray-400 mt-4 max-w-md">
          Se você cria, nós ajudamos a divulgar.
        </p>
      </div>
