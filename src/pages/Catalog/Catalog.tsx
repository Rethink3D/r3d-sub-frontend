...
const mockProducts = [
  {
    id: 1,
    imageUrl:
      "https://http2.mlstatic.com/D_NQ_NP_835409-MLA49244622240_022022-W.webp",
    ...
    description:
      "Uma incrível action figure do Pikachu Detetive, feita com resina de alta qualidade e pintura detalhada à mão. Perfeito para colecionadores.",
    width: "15cm",
    height: "20cm",
    maker: {
      name: "Ana Silva",
  ...
  },
  {
    id: 2,
    imageUrl:
      "https://http2.mlstatic.com/D_NQ_NP_859203-MLA74092173275_012024-W.webp",
    ...
    description:
      "Boneco do Charmander em pose de batalha, com articulações nos braços e pernas. Ideal para brincar e decorar.",
    width: "12cm",
    height: "18cm",
    maker: {
      name: "Bruno Costa",
  ...
  },
  {
    id: 3,
    imageUrl:
      "https://http2.mlstatic.com/D_NQ_NP_941198-MLB53740265824_022023-W.webp",
    ...
    description:
      "Funko Pop original do Snorlax, item indispensável para qualquer coleção Pokémon.",
    width: "9cm",
    height: "10cm",
    maker: {
      name: "Carla Dias",
              ...
              productsToShow.length < filteredAndSortedProducts.length && (
                <div className="mt-12 text-center">
                  <button
                    ...
                    className="bg-blue-600 text-white font-semibold rounded-lg px-8 py-3 hover:bg-blue-700 transition-transform duration-200 hover:scale-105"
                  >
                    Carregar Mais
                  </button>
                </div>
