...
const FilterIcon = () => (
  ...
  >
    ...
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V19l-4 2v-6.586a1 1 M00-.293.707L3.293 7.293A1 1 0 013 6.586V4z"
    />{" "}
  </svg>
);
            ...
            <li key={category}>
              <button
                onClick={() => {
                  ...
                  if (inDrawer) setIsMobileFiltersOpen(false);
                }}
    ...
    <>
      ...
      {isMobileFiltersOpen && (
        <div role="dialog" aria-modal="true">
          ...
          ></div>
          <div
            className={`fixed top-0 left-0 h-full w-full max-w-xs bg-white dark:bg-gray-900 z-50 transform transition-transform ${
      ...
      <button
        ...
        className="lg:hidden fixed bottom-6 right-6 bg-blue-600 text-white p-4 rounded-full shadow-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 z-30"
      >
        <FilterIcon />
      </button>
