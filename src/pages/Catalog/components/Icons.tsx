...
export const CursorClickIcon: React.FC<IconProps> = ({ className }) => (
   <svg className={className || "w-4 h-4"} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 15l-2 5L9 9l11 4-5 2zm0 0l5.657-5.657a2 2 0 10-2.828-2.828L15 15z" />
  </svg>
);
...
export const LoadingSpinner: React.FC<IconProps> = ({ className }) => (
  <svg
    className={className || "animate-spin h-8 w-8 text-blue-500"}
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
  >
